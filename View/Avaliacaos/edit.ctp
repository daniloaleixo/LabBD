...
<?php echo $this->Form->create('Avaliacao'); ?>
	<fieldset>
		<legend><?php echo __('Edit Avaliacao'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Avaliacao.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Avaliacao.id'))); ?></li>
